...
//               <span className="brand-typing">| {typedText}</span>
//             </div>
...
//                 <span className="link-icon"></span>
//                 Resume
//                 {isHovered && <span className="download-animation">⬇</span>}
//               </a>
...
//                 © 2026 Darshi Anil Kumar • Built with  using React
//               </p>
          ...
          <nav className="navbar" style={{ background: isDarkMode ? '#0a0a0a' : '#ffffff' }}>
            ...
            <div className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
              ...
              >
                <span className="link-icon" style={{ color: '#007bff' }}></span>
                Resume
                {isHovered && <span className="download-animation" style={{ color: '#007bff' }}>⬇</span>}
              </a>
